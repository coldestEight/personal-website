...
export default function S24() {
  return (
    <>
      ...
      <ImgCaption
        imgsrc={["../s24img1.png"]}
        caption="An example of a graph from the older project, comparing the difference in price between different level retailers"
      />
      {bodyText(
      ...
      <ImgCaption
        imgsrc={["../s24img2.png"]}
        caption="An example of a graph from my project, comparing the price of milk in $CAD"
      />
      ...
      <ImgCaption
        imgsrc={["../s24img3.png"]}
        caption="A picture of my task board, as of the last day of my term"
      />
